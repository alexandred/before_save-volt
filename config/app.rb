...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'before-save-volt.com'
  config.app_name = 'Before_save-volt'
  config.mailer.from = 'Before_save-volt <no-reply@before-save-volt.com>'
  ...
  #
  config.app_secret = '2BDcRTgpAZ9F980yVqZ8-fuhlROmWR5UNU_SXlDBwecMczusleaEDlBxCfalnwFcPvw'
